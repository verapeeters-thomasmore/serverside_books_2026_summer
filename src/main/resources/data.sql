...
INSERT INTO PUBLISHER (ID, NAME, CITY, BASE_DISCOUNT_PERCENTAGE, BULK_PURCHASE_QUANTITY, BULK_DISCOUNT_PERCENTAGE) VALUES
    ('De Gouden Druk', 'Antwerpen', 3.0, 500, 12.0);

INSERT INTO PUBLISHER (ID, NAME, CITY, BASE_DISCOUNT_PERCENTAGE, BULK_PURCHASE_QUANTITY, BULK_DISCOUNT_PERCENTAGE) VALUES
    ('De Twee Zwanen', 'Brussel', 4.0, 400, 15.0);

INSERT INTO PUBLISHER (ID, NAME, CITY, BASE_DISCOUNT_PERCENTAGE, BULK_PURCHASE_QUANTITY, BULK_DISCOUNT_PERCENTAGE) VALUES
    ('Vlaamse Letters', 'Gent', 2.5, 600, 10.0);

INSERT INTO PUBLISHER (ID, NAME, CITY, BASE_DISCOUNT_PERCENTAGE, BULK_PURCHASE_QUANTITY, BULK_DISCOUNT_PERCENTAGE) VALUES
    ('Noorderlicht', 'Mechelen', 5.0, 300, 18.0);

INSERT INTO PUBLISHER (ID, NAME, CITY, BASE_DISCOUNT_PERCENTAGE, BULK_PURCHASE_QUANTITY, BULK_DISCOUNT_PERCENTAGE) VALUES
    ('Boekengilde', 'Hasselt', 3.5, 700, 11.5);
